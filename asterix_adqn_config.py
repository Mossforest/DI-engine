...
asterix_averaged_dqn_config = dict(
    exp_name='asterix_averaged_dqn_seed0_prime10',
    env=dict(
        collector_env_num=8,
        evaluator_env_num=8,
...
asterix_averaged_dqn_config = EasyDict(asterix_averaged_dqn_config)
main_config = asterix_averaged_dqn_config
asterix_averaged_dqn_create_config = dict(
    env=dict(
        type='atari',
...
asterix_averaged_dqn_create_config = EasyDict(asterix_averaged_dqn_create_config)
create_config = asterix_averaged_dqn_create_config
