...
from dizoo.box2d.bipedalwalker.config.bipedalwalker_hardcore_collect import main_config, create_config


def main(seed):
    logging.getLogger().setLevel(logging.INFO)
    main_config.seed = seed
    main_config.policy.collect.save_path = f'./bipedalwalker_hardcore_collect/expert_{seed}.pkl'
