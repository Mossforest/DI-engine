...
def serial_pipeline_worldmodel(
    ...
    Returns:
        - world_model (:obj:`Policy`): Converged world_model.
    """
    ...
    dataloader = DataLoader(
        ...
        # correspondingly.
        cfg.world_model.learn.batch_size // get_world_size(),
    ...
    for epoch in range(cfg.world_model.learn.train_epoch):
        ...
        for train_data in dataloader:
            ...
            batch_size = cfg.world_model.learn.batch_size
            world_model.train(train_data, collector.envstep, learner.train_iter, batch_size, batch_length)
