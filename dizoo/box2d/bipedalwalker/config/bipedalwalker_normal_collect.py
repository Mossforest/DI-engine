...
bipedalwalker_sac_config = dict(
    exp_name='bipedalwalker_normal_collect',
    seed=123,
    env=dict(
    ...
    policy=dict(
        ...
        collect=dict(
            n_sample=10000,
            save_path='./bipedalwalker_normal_collect/expert.pkl',
            data_type='hdf5',
            state_dict_path='./bipedalwalker_normal_pretrain/ckpt/ckpt_best.pth.tar',
        ),
    ),
)
